"""
Django settings for misty_union_43274 project.
...
ROOT_URLCONF = 'misty_union_43274.urls'
...
WSGI_APPLICATION = 'misty_union_43274.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_union_43274 API",
    "DESCRIPTION": "API documentation for misty_union_43274 App",
    "VERSION": "v1",
}
